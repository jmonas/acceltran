...
model0 =ViltForQuestionAnswering.from_pretrained("/home/jmonas/acceltran/training/ViLT/test/vilt-saved-model-0", config=configuration0, use_safetensors=True)
