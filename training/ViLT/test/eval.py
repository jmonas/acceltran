...
model =ViltForQuestionAnswering.from_pretrained("/scratch/gpfs/jmonas/ViLT/Models/l6_h512_i1024/vilt-saved-model-2-14", config=configuration, use_safetensors=True)
